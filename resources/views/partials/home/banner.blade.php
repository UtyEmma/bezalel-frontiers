        ...
        <div class="swiper-wrapper">
            @forelse ($sliders as $slider)
                <div class="swiper-slide">
                    ...
                    before:top-0 before:w-full before:h-full before:bg-[#040128] before:opacity-[0.7] "
            ...
            @empty
                <div class="swiper-slide">
                    <div class="slide-inner slide-bg-image before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-[#040128] before:opacity-[0.7]" data-background="{{asset('assets/imgs/bezalel-frontiers-business-meeting.jpg')}}" >
                        <!-- <div class="gradient-overlay"></div> -->
                        <div class="wraper">
                            <div class="relative h-[900px] lg:h-[680px]  md:h-[600px] sm:h-[500px]">
                                <div class="lg:w-4/6 md:w-full  absolute top-1/2 left-0 transform  -translate-y-1/2">
                                    ...
                                    <div data-swiper-parallax="400" class="slide-text">
                                        <p class="text-[22px] text-[#e2e2e2] font-base-font leading-[35px] mb-[40px] md:text-[18px] col:leading-[25px] col:mb-[30px]">
